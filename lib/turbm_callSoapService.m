...
%
% This file is a modification to the standard callSoapService file that
% comes with Matlab. The original revision information is left in this
% file.
%
% In this file, we are no longer expecting a DOM object, but a string. So
% there is no need to call the serializeDOM() function anymore.
%

function resp = turbm_callSoapService(endpoint,soapAction,message)
...
toSend = java.lang.String(message);
